...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临心之语聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
	...
	$(function(){
 	...
 	function check(){
		var url = "${pageContext.request.contextPath}/user?"+new Date().getTime();
		$.post(
			url,
			{'method':'check'},
			function(data){
				if(data == 1){
					alert("您已被管理员踢下线，请重新登录！");
	...
	function showOnLine(){
   	...
   	function showContent(){
		var url = "${pageContext.request.contextPath}/user?"+ new Date().getTime();
		$.post(url,{'method':'getMessage'},function(data){
...
<body>
	...
	<table width="778" height="276" border="0" align="center"
		...
		<tr>
			<td background="images/left.jpg" width="165" valign="top" bgcolor="#f6fded" id="online" style="padding:5px">在线人员列表</td>
	...
	<table width="778" height="95" border="0" align="center"
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<input name="from" type="hidden" value="${existUser.username}">[ 我 ]对 
			...
			<tr>
				...
				<td colspan="2" align="center" class="word_dark">&nbsp;All
					CopyRights reserved 2018  武汉大学计算机学院 李强</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
	</table>
