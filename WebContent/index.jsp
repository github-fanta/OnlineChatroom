...
<body>
	...
	<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/user" onSubmit="return check()">
		...
		<table width="400" height="300" border="0" align="center" cellpadding="0" cellspacing="0" background="images/login.jpg">
			
			<tr>
				<td height="120" align="center" colspan="3" class="word_dark">&nbsp;<h1><font color="green">Chatroom</font></h1></td>
			</tr>
			<tr>
